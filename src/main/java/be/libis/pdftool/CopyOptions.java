...
public interface CopyOptions extends CommonOptions {
  ...
  @Option(longName= "image_scale", description = "Compress the embedded images by scaling (factor: 1.0 - 0.0) [0.5]", defaultValue = "0.5")
  float getImageScale();
