...
@Command(name = "header", description = "Create a copy of a PDF file with a watermark in the page header")
public class WatermarkHeader implements Runnable {
    @Spec
    ...
    private void validate() {
        ...
        // TODO: Add validations for added options here
